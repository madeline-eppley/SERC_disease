...
The figure generated by the above code script is below. We clearly have unequal data points per year:

<img width="853" height="853" alt="image" src="https://github.com/user-attachments/assets/6d4c7139-b161-4e0b-bb08-3957ea6fa2e8" />

> [!NOTE]
> For now, I'm not worried about subsetting and will use all available data, but this is something to flag to discuss with Katrina. 
