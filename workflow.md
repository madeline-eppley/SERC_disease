...
### Standardizing data columns and resolving missingness, adding co-infection columns
...
- I'm also going to want to combine some columns to make new variables for co-infections (Y/N or sum), infected with dermo only, infected with polydora only, and uninfected. 
