...
#rawfile <- "/Users/madelineeppley/Desktop/MarineGeo_OysterData_SevernSouthRhodeWest_2025.08.25.xlsx" # old data
rawfile <- "/Users/madelineeppley/Desktop/MarineGeo_OysterData_SevernSouthRhodeWest_2025.11.19.xlsx" # new data! 2022-2025

# read in data - but just keep 2022-2025 since there is no bioeroder data for 2021.
#data_2022 <- read_excel(rawfile, sheet = "RawData_2022") # old data
#data_2023 <- read_excel(rawfile, sheet = "Data2023") # old data
#data_2024 <- read_excel(rawfile, sheet = "Data2024") # old data
data <- read_excel(rawfile, sheet = "Data") # this new file has combined all of the years of data together! 
...
> [!NOTE]
> I am going to get rid of the Rhode data from 2022 since we don't have Rhode data for 2023-2025. we can discuss if there's any value in reporting the data anyway somewhere in the paper!


### Standardizing data columns - old data
Before getting the combined dataset, the old data format was pretty messy, where columns had slightly different names year-to-year. However, this has been solved! 
, and we also have a good amount of missingness throughout.
I should tackle this step-by-step:
